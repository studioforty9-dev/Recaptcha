...
class Studioforty9_Recaptcha_Test_Helper_Data extends EcomDev_PHPUnit_Test_Case
{
    ...
    public function test_getTheme_returns_correct_value()
    {
        $expected = Mage::getStoreConfig(Studioforty9_Recaptcha_Helper_Data::MODULE_KEY_THEME);
        $actual = $this->helper->getTheme();
